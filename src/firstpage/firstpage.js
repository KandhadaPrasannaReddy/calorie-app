        ...
        render(){
            return(
                <div>
                    ...
                    <button class="btn btn-large btn-block btn-primary full-width" type="button" onClick={this.onLoginChange} >Login</button>
                    <button class="btn btn-large btn-block btn-primary full-width" type="button"onClick={this.onSignUpChange} >Sign Up</button>
                </div>
