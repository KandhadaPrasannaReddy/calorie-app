...
//         document.bmiForm.bmi.value = finalBmi
//         if (find("mbutton").checked) {
//           if (finalBmi <= 20) {document.bmiForm.meaning.value ="You're underweight"}
//           else if ((finalBmi > 20) && (finalBmi <= 25)) {document.bmiForm.meaning.value = "You're normal"}
//           else if ((finalBmi > 25) && (finalBmi <= 30)) {document.bmiForm.meaning.value ="You're over weight"}
//           else if ((finalBmi > 30) && (finalBmi <= 40)) {document.bmiForm.meaning.value ="You're obese"}
//           else {document.bmiForm.meaning.value ="You're seriously obese"}

//         }

//         else  if (find("fbutton").checked) {
          
//           if (finalBmi<= 18.5) {document.bmiForm.meaning.value ="You're underweight"}
//           else if ((finalBmi > 18.5) && (finalBmi <= 24)) {document.bmiForm.meaning.value = "You're normal"}
//           else if ((finalBmi > 24) && (finalBmi <= 30)) {document.bmiForm.meaning.value ="You're over weight"}
//           else if ((finalBmi > 30) && (finalBmi <= 40)) { document.bmiForm.meaning.value ="You're obese"}
//           else {document.bmiForm.meaning.value ="You're seriously obese"}
...
//         console.log("AGE IN GOAL",Math.floor(years_elapsed))
